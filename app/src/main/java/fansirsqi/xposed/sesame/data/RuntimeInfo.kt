...
class RuntimeInfo private constructor() {
    ...
    init {
        ...
        val content = Files.readFromFile(Files.runtimeInfoFile(userId)!!)
    ...
    operator fun get(key: RuntimeInfoKey): Any? {
     ...
     * @return 对应的字符串值
     */
    fun getString(key: RuntimeInfoKey): String {
     ...
     * @return 对应的 long 值
     */
    fun getLong(key: RuntimeInfoKey): Long {
    ...
    companion object {
        ...
        fun getInstance(): RuntimeInfo {
            if (instance == null || instance!!.userId != UserMap.currentUid) {
